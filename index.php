...
if($_POST['METHOD']=='POST'){
    ...
    $correo=$_POST['correo'];
    $query="insert into usuarios(nombre, especialidad, correo) values ('$nombre', '$especialidad', '$correo')";
...
if($_POST['METHOD']=='PUT'){
    ...
    $especialidad=$_POST['especialidad'];
    $correo=$_POST['correo'];
    $query="UPDATE usuarios SET nombre='$nombre', especialidad='$especialidad', correo='$correo' WHERE id='$id'";
